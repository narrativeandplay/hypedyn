...
% - display the number fact for debugging
...
% - update condition on end link - stop if true discussion
% - edit node rule, instead of setting to fact, set to random between input 1
% and input 2
% - try it - say something about danger of randomization (and benefits)
% - add randomize link, to show that can set from links, node refreshes
