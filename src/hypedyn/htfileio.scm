                                                       ...
                                                       (case num-fact-mode
                                                           ...
                                                           (("Random")
                                                            (let ((operand1 (list-ref (list-ref expr 3) 0))
                                                                  ...
                                                                  (operand2 (list-ref (list-ref expr 3) 2))
                                                                  (operand2-type (list-ref (list-ref expr 3) 3))
                                                                  (start-type-hash (make-hash-table))
                                                                  (start-value-hash (make-hash-table))
                                                                  (end-type-hash (make-hash-table))
                                                                  (end-value-hash (make-hash-table)))
                                                                (hash-table-set! action-hash 'type "union")
                                                                (hash-table-set! action-hash 'value "randomValue")
                                                                (hash-table-set! the-param-hash 'updateValue action-hash)
                                                                (hash-table-set! value-hash 'type "product")
                                                                (hash-table-set! value-hash 'value "start:end")
                                                                (hash-table-set! the-param-hash 'randomValue value-hash)

                                                                ; start
                                                                (hash-table-set! start-type-hash 'type "union")
                                                                ...
                                                                ; end
                                                                (hash-table-set! end-type-hash 'type "union")
